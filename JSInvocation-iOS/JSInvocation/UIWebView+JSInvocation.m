...
static inline id __JI__genNil( void )
{
...
static inline id __JI__getPtr( NSNumber * object )
{
...
static id inline __OC__invokeMethod( NSObject * object, NSString * method, NSArray * arguments )
{
    ...
    {
        JI_ERROR( @"[WebView JSCore] Object <%@: %p>, cannot invoke method '%@'", [object class], object, method );
        return nil;
    }
    ...
    //	else
    {
        JI_INFO( @"[WebView JSCore] Object <%@: %p>, invoke method '%@'", [object class], object, method );
    }
